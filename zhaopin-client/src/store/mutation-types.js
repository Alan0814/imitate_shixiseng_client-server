...
export const UPDATE_USER_INFO = 'update_user_info' // 接收用户信息
export const UPDATE_POST_INFO = 'update_post_info' // 更新招聘信息
export const RECEIVE_EMPLOYEE = 'receive_employee' // 接收用户信息
